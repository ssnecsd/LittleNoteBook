      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if(res.data.state_code==1){
            ...
            that.data.excerpt_group_list.splice(y, 1)
            that.setData({
              excerpt_group_list: that.data.excerpt_group_list,
            })
          }else{
            //显示删除失败提示
            $wuxToptips().show({
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if(res.data.state_code==1){
            ...
            that.data.excerpt_group_list[y].group_name = that.data.contentInInput
            that.data.excerpt_group_list[y].group_color = that.data.color[that.data.cur]
            that.setData({
              excerpt_group_list: that.data.excerpt_group_list,
              show_window: 0,
            })
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if(res.data.state_code==1){
            ...
            that.data.excerpt_group_list = that.data.excerpt_group_list.concat(newitem)
            that.setData({
              excerpt_group_list: that.data.excerpt_group_list,
              show_window: 0,
            })
